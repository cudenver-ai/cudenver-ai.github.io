...
export default function ProblemPage({ setCurrentPage }) {
              ...
              <ol style={{ paddingLeft: "20px" }}>
                ...
                <li>
                  ...
                  <ul style={{ paddingLeft: "20px", listStyleType: "disc" }}>
                    ...
                    <li>
                      Higher SSIM values (closer to 1) indicate a more
                      successful attack since it implies that the perturbation
                      was perceptually subtle yet effective.
                    </li>
                  </ul>
                </li>
              </ol>
